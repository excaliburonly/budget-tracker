    ...
    return (<div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <header className="mb-10 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Track your security buffer across different
            ...
            <section
                className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 p-8 shadow-sm mb-10 overflow-hidden relative">
            ...
            <span className="text-4xl font-extrabold text-emerald-600 tracking-tight">
              {formatCurrency(totalCurrentAmount, currency)}
                ...
                <div
                    className="flex justify-between items-center text-xs font-bold uppercase tracking-widest text-emerald-600 dark:text-emerald-400">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                    ...
                    {funds.length === 0 ? (<div
                            ...
                            <p className="text-sm text-gray-400 mt-1">Start by defining where you park your emergency
                                money.</p>
                            ...
                            {funds.map((fund: EmergencyFund) => {
                                ...
                                return (<div key={fund.id}
                                             className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col justify-between group relative">
                                        <div>
                                            <div className="flex items-start justify-between mb-4">
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    <span
                                                        className="text-xs text-gray-500 font-medium">{fund.institution_name || 'Personal Custody'}</span>
                                                </div>
                                                <div className="flex gap-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-1 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/10 rounded-md transition-colors"
                                                        title="Delete Fund"
                                                    >
                                            ...
                                            <div className="flex justify-between text-sm mb-2 pt-4">
                                                ...
                                                <span
                                                    className="text-gray-900 dark:text-white font-bold">{formatCurrency(Number(fund.current_amount), currency)}</span>
                                            </div>
                                            <div
                                                className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-1.5 overflow-hidden mb-6">
                                                <div
                                        ...
                                        <div
                                            className="pt-4 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center">
                                            <div className="flex flex-col">
                                                <span
                                                    className="text-[10px] text-gray-400 uppercase font-bold tracking-tighter">Target</span>
                                                <span
                                                    className="text-xs font-bold text-gray-600 dark:text-gray-400">{formatCurrency(Number(fund.target_amount), currency)}</span>
                                            </div>
                                            <div className="text-right">
                         <span
                             className="px-2 py-0.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded text-[10px] font-extrabold">
                ...
                <div>
                    ...
                    <div
                        className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-900/20">
