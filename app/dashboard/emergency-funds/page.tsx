...
import { getEmergencyFunds, deleteEmergencyFund } from "./actions";
          ...
          {funds.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {funds.map((fund: EmergencyFund) => {
                ...
                return (
                  <div key={fund.id} className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col justify-between group relative">
                    <div>
