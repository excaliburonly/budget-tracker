...
import { getInvestments, deleteInvestment } from "./actions";
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {investments.length === 0 ? (
                  ...
                  investments.map((inv) => {
                    ...
                    return (
                      <tr key={inv.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors group">
                        <td className="px-6 py-4">
                          <div className="flex flex-col">
                            <span className="text-sm font-bold text-gray-900 dark:text-white">{inv.asset_name}</span>
                            <span className="text-xs text-gray-500 font-mono">{inv.symbol || 'N/A'}</span>
                          </div>
                        </td>
