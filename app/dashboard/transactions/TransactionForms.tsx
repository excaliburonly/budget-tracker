...
export function AddTransactionForm({
    ...
    return (<div
            className="bg-surface p-6 rounded-2xl border border-surface-border shadow-sm mb-8">
            ...
            <form action={addTransaction} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {type !== 'transfer' ? (<div className="flex flex-col gap-1.5">
                        ...
                        <label className="text-sm font-medium text-foreground/80">To Account
                            (Destination)</label>
                        <select
                            name="to_account_id"
                ...
                <div className="flex flex-col gap-1.5">
                    <label className="text-sm font-medium text-foreground/80">Link to Emergency
                        Fund</label>
                    <select
...
export function EditTransactionModal({
    ...
    return (<div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div
                className="bg-surface p-8 rounded-3xl border border-surface-border shadow-2xl max-w-2xl w-full">
                ...
                <form action={async (formData) => {
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-sm font-medium text-foreground/80">Link to
                            Investment</label>
                        <select
                            name="investment_id"
...
export function AddCategoryForm({categories}: { categories: Category[] }) {
    ...
    return (<div
            className="bg-background/50 p-6 rounded-2xl border border-dashed border-input-border mb-8">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-md font-semibold text-foreground">Categories</h3>
                <button onClick={() => setShowForm(false)}
                        className="text-xs text-text-muted hover:text-gray-700 font-medium">Close
                </button>
            </div>
            ...
            <form action={async (formData) => {
                await addCategory(formData);
                  ...
                  className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8 pb-8 border-b border-surface-border">
                <div className="flex flex-col gap-1.5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
              ...
              {category.type}
                        ...
                        <div
                            className="flex items-center justify-center gap-2 mt-3 pt-3 border-t border-surface-border w-full">
                            <button
...
export function EditCategoryModal({category, onCloseAction}: { category: Category, onCloseAction: () => void }) {
    return (<div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div
                className="bg-surface p-8 rounded-3xl border border-surface-border shadow-2xl max-w-lg w-full">
