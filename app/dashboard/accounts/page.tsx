    ...
    <div className="max-w-6xl mx-auto">
      <header className="mb-10 flex justify-between items-end">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your multiple bank accounts and their balances</p>
        </div>
      </header>
            ...
            accounts.map((account) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <span className="text-xs font-semibold text-blue-600 uppercase tracking-wider bg-blue-50 dark:bg-blue-900/20 px-2 py-0.5 rounded-full">
                      {account.type}
                    </span>
